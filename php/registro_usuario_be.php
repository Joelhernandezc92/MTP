...
if (!filter_var($correo, FILTER_VALIDATE_EMAIL)) {
    echo '
    <script>
        alert("Formato de correo electrónico inválido. Introduce un correo válido.");
...
// Resto del código para verificar la existencia de correo, usuario y nombre (sin cambios)
